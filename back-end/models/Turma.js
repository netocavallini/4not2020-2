...
const esquema = mongoose.Schema({
    ...
    data_final: {
        ...
        validate: {
            validator: function(valor) {
                return valor >= this.data_inicial // /\d{3}-\d{3}-\d{4}/.test(v);
            },
    ...
    // Valores que usam apenas a parte de hora de uma data são manipulados 
    // mais facilmente como String
...
*/
module.exports = mongoose.model('Turma', esquema, 'turmas')  // 3 parâmetros