...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await Galeria.find()
        .populate('cadastro', 'email') // Somente o atributo nome
        .populate('cristal')  // Todos os atributos   
...
controller.obterUm = async (req, res) => {
    try{
        ...
        let obj = await Galeria.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Galeria.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    ...
    let ret = await Galeria.findByIdAndDelete(id)
