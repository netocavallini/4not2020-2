...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await Notificacao.find()
...
controller.obterUm = async (req, res) => {
    try{
        ...
        let obj = await Notificacao.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Notificacao.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    ...
    let ret = await Notificacao.findByIdAndDelete(id)
