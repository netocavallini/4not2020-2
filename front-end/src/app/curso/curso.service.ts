...
export class CursoService {
  ...
  excluir(id: string) {
    //O método "delete" nativo do HTTPClient não suporta a passagem de um body para o 
    // back-end 
    // return this.http.delete(this.apiServer + 'curso/' + id).toPromise()

    // O método request() pode ser usado com qualquer verbo e aceit a passagem de body
